export default class Calculator {
    ...
    createHTMLElement(tag,classes,parentElement,text) {
    ...
    constructor() {
        ...
        this.createHTMLElement("button","calcul__total",calculator, "=").id="=";
        ...
        for(let i=0;i<lisArr.length;i++) {
            let bbutton = this.createHTMLElement("button",lisArr[i].class,li,lisArr[i].text);
        }
    };
